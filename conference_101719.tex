...
\begin{abstract}
Modern distributed database systems scale horizontally by sharding their data across a large number of nodes.
...
%If a transaction's ${out}$ is not empty, there must be some transactions that have violated its locks.
%All the dependent outer transactions are also neither decided nor uncertain.
...
\begin{figure}[tbp]
  ...
  \subfloat[${H_a}$]
  {
    \includegraphics[scale=1.2] {figure/version1} \label{fig:versions_a}}
    \captionsetup[subfigure]{margin={0cm,0cm}
  }
  \subfloat[\small ${H_b}$]
  {
    \includegraphics[scale=1.2]{figure/version2} \label{fig:versions_b}
  }
    \captionsetup[subfigure]{margin={0cm,0cm}
  }
  \subfloat[\small ${H_c}$]
  {
    \includegraphics[scale=1.2] {figure/version3} \label{fig:versions_c}}
    \captionsetup[subfigure]{margin={0cm,0cm}}
    \subfloat[\small ${H_d}$]
      { \includegraphics[scale=1.2]{figure/version4} \label{fig:versions_d}
  }
...
%Additional edges in WFG at any time, in turn, lead to more likely deadlock and a greater abort rate.
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.32] {figure/plot_ycsb_terminal_g_o_tpm} \label{fig:ycsb_add_terminal_gathered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.32]{figure/plot_ycsb_terminal_g_o_abort} \label{fig:ycsb_add_terminal_gathered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
%While DLV0 and DLV1 perform early lock violation, and they suffer from an increased chance of serializability breach and cascade aborts.
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.32] {figure/plot_ycsb_latency_g_o_tpm} \label{fig:new_order_add_log_cost:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.32]{figure/plot_ycsb_latency_g_o_abort} \label{fig:new_order_add_log_cost:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
      \caption{Impact of Geo-distance on Performance (YCSB) }
...
\begin{figure}[tbp]
  ...
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.32] {figure/plot_tpcc_warehouse_g_o_tpm} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.32]{figure/plot_tpcc_warehouse_g_o_abort} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.32] {figure/plot_tpcc_hotitem_g_o_tpm} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.32]{figure/plot_tpcc_hotitem_g_o_abort} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.32] {figure/plot_tpcc_theta_g_o_tpm} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.32]{figure/plot_tpcc_theta_g_o_abort} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
%When the test reaches the maximum number of concurrent terminals, DLV1x is twice the throughput of S2PL.
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.32] {figure/plot_tpcc_terminal_g_o_tpm} \label{fig:new_order_add_terminal_gathered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.32]{figure/plot_tpcc_terminal_g_o_abort} \label{fig:new_order_add_terminal_gathered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.32] {figure/plot_tpcc_terminal_s_o_tpm} \label{fig:new_order_add_terminal_scattered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.32]{figure/plot_tpcc_terminal_s_o_abort} \label{fig:new_order_add_terminal_scattered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[TPCC interactive transactions TPM]
    { 
      \includegraphics[scale=0.20] {figure/plot_interactive__tpcc_neworder_add_Terminal_Terminal_TPM_gather} \label{fig:tpcc_add_terminal_interactive:tpm}
      \captionsetup[subfigure]{margin={0cm,0cm}}
    }
    \subfloat[TPCC interactive transactions abort rate]
    { 
      \includegraphics[scale=0.20]{figure/plot_interactive__tpcc_neworder_add_Terminal_Terminal_Abort_gather} \label{fig:tpcc_add_terminal_interactive:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[\small no transactions access non-exist rows]
      { \includegraphics[scale=0.26] {figure/plot__tpcc_neworder_add_NonExist_0.pdf} \label{fig:evaluation_cascade_abort:without_nonexist_row}

      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
  \subfloat[\small 10\% transactions access non-exist rows]
      { \includegraphics[scale=0.26]{figure/plot__tpcc_neworder_add_NonExist_10.pdf} \label{fig:evaluation_cascade_abort:nonexist_row}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[Deadlock detection]
      { \includegraphics[scale=0.26] {figure/tpcc_neworder_add_Terminal_latency_Detection.pdf} \label{fig:evaluation_latency:deadlock_detection}
      }
  \subfloat[Deadlock prevention]
      { \includegraphics[scale=0.26]{figure/tpcc_neworder_add_Terminal_latency_WaitDie.pdf} \label{fig:evaluation_latency:deadlock_prevention}}
...
This work was supported by Alibaba Group through Alibaba Innovative Research (AIR) Program and partially supported by the NSFC Project No. 61772202.
