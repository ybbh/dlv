...
Figure~\ref{fig:two_layers_architecture} illustrates the commit process of DLV1x.
...
Figure~\ref{fig:versions_example} illustrates why \emph{ww}-dependencies are not needed for recovery.
...
In \the emph{Commit} function, if DLV2 is used, it will first enable lock violation.
