...
Thus, through lock violation we can exclude data synchronization completely from the lock holding time. %This will be elaborated in the following section.
...
%\footnote{we suppose there is no lock upgrade, so there are no conflict locks hold by one transaction}.
...
If the $in$ is equal to 0, it activate the corresponding transaction that is onhold.  
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder speedup ratio]
  { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_LogForceT_LogForceT_Ratio_gather} \label{fig:new_order_add_log_cost:ratio}}

\caption{throughput and abort rate of
different terminal different log write costs(cloud setting)}
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_neworder_add_LogForceT_local_LogForceT_TPM_gather} \label{fig:new_order_add_log_cost_local:tpm}}
  
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_LogForceT_local_LogForceT_Abort_gather} \label{fig:new_order_add_log_cost_local:abort}}

  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder speedup ratio]
  { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_LogForceT_local_LogForceT_Ratio_gather} \label{fig:new_order_add_log_cost_local:ratio}}
...
\begin{figure}[htbp]
  ...
  \subfloat[NewOrder abort rate]
      ...
      \captionsetup[subfigure]{margin={0cm,0cm}}
      \subfloat[NewOrder speedup ratio]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_Warehouse_Warehouse_Ratio_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:ratio}}
...
\begin{figure}[htbp]
  ...
  \subfloat[YCSB workload abort rate]
      { \includegraphics[scale=0.25]{figure/plot_ycsb_add_Theta_Theta_Abort_gather.pdf} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
      \subfloat[YCSB workload speedup ratio]
          { \includegraphics[scale=0.25]{figure/plot_ycsb_add_Theta_Theta_Ratio_gather.pdf} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:ratio}}
...
\begin{figure}[htbp]
  ...
  \subfloat[NewOrder abort rate]
      ...
      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder speedup ratio]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Ratio_gather} \label{fig:new_order_add_terminal_gathered:ratio}}
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_neworder_add_Terminal_wh10_Terminal_TPM_gather} \label{fig:new_order_add_terminal_gathered_wh10:tpm}}
  
      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_Terminal_wh10_Terminal_Abort_gather} \label{fig:new_order_add_terminal_gathered_wh10:abort}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder speedup ratio]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_Terminal_wh10_Terminal_Ratio_gather} \label{fig:new_order_add_terminal_gathered_wh10:ratio}}

\caption{throughput and abort rate when adding terminal number of each shard, in gathered mode}
\label{fig:new_order_add_terminal_gathered_wh10}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \subfloat[NewOrder abort rate]
      ...
      \captionsetup[subfigure]{margin={0cm,0cm}}
      \subfloat[NewOrder speedup ratio]
          { \includegraphics[scale=0.25]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Ratio_scatter} \label{fig:new_order_add_terminal_scattered:ratio}}
