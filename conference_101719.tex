...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.3] {figure/plot_ycsb_add_Terminal_Terminal_TPM_gather} \label{fig:ycsb_add_terminal_gathered:tpm}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.3]{figure/plot_ycsb_add_Terminal_Terminal_Abort_gather} \label{fig:ycsb_add_terminal_gathered:abort}}
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[]
      { \includegraphics[scale=0.3] {figure/plot_ycsb_add_LogForceT_LogForceT_TPM_gather} \label{fig:new_order_add_log_cost:tpm}}

  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[]
      { \includegraphics[scale=0.3]{figure/plot_ycsb_add_LogForceT_LogForceT_Abort_gather} \label{fig:new_order_add_log_cost:abort}}
...
\begin{figure}[tbp]
  ...
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.3] {figure/plot_tpcc_neworder_add_Warehouse_Warehouse_TPM_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.3]{figure/plot_tpcc_neworder_add_Warehouse_Warehouse_Abort_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:abort}}
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.3] {figure/plot_tpcc_neworder_add_HotItem_HotItem_TPM_gather} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.3]{figure/plot_tpcc_neworder_add_HotItem_HotItem_Abort_gather} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:abort}}
...
\begin{figure}[tbp]
  ...
  \subfloat[YCSB workload TPM]
      { \includegraphics[scale=0.3] {figure/plot_ycsb_add_Theta_Theta_TPM_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB workload abort rate]
      { \includegraphics[scale=0.3]{figure/plot_ycsb_add_Theta_Theta_Abort_gather.pdf} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}}
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.3] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_gather} \label{fig:new_order_add_terminal_gathered:tpm}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.3]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_gather} \label{fig:new_order_add_terminal_gathered:abort}}
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.3] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_scatter} \label{fig:new_order_add_terminal_scattered:tpm}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.3]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_scatter} \label{fig:new_order_add_terminal_scattered:abort}}
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[]
      { \includegraphics[scale=0.3] {figure/plot_interactive__tpcc_neworder_add_Terminal_Terminal_TPM_gather} \label{fig:tpcc_add_terminal_interactive:tpm}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[abort rate]
      { \includegraphics[scale=0.3]{figure/plot_interactive__tpcc_neworder_add_Terminal_Terminal_Abort_gather} \label{fig:tpcc_add_terminal_interactive:abort}}
...
\begin{figure}[tbp]
  ...
  \subfloat[no transactions access non-exist rows]
      { \includegraphics[scale=0.2] {figure/plot__tpcc_neworder_add_NonExist_0.pdf} \label{fig:evaluation_cascade_abort:without_nonexist_row}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[10\% transactions access non-exist rows]
      { \includegraphics[scale=0.2]{figure/plot__tpcc_neworder_add_NonExist_10.pdf} \label{fig:evaluation_cascade_abort:nonexist_row}}
...
\begin{figure}[tbp]
  ...
  \subfloat[Deadlock detection]
      { \includegraphics[scale=0.2] {figure/tpcc_neworder_add_Terminal_latency_Detection.pdf} \label{fig:evaluation_latency:deadlock_detection}}

      \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[Deadlock prevention]
      { \includegraphics[scale=0.2]{figure/tpcc_neworder_add_Terminal_latency_WaitDie.pdf} \label{fig:evaluation_latency:deadlock_prevention}}

\caption{Transaction Latency}
\label{fig:evaluation_latency}
\end{figure}

DLV cannot directly impact on transactions latency.
Although DLV shorten the possible lock blocking time, it must wait its dependent transactions commit.
We evaluation transacation latency using TPCC workload. 
The warehouse nubmer was fixed to 40 and the terminal number was set to 10, 100 and 200.
Different with other evaluation seting.
Transaction was immediately retried five times after it aborted without wait.
Only the average latency of committed transactions are consitered.
We 
