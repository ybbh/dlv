...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.25] {figure/plot_ycsb_terminal_g_o_tpm} \label{fig:ycsb_add_terminal_gathered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.25]{figure/plot_ycsb_terminal_g_o_abort} \label{fig:ycsb_add_terminal_gathered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.25] {figure/plot_ycsb_latency_g_o_tpm} \label{fig:new_order_add_log_cost:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.25]{figure/plot_ycsb_latency_g_o_abort} \label{fig:new_order_add_log_cost:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_warehouse_g_o_tpm} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_warehouse_g_o_abort} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_hotitem_g_o_tpm} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_hotitem_g_o_abort} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.25] {figure/plot_ycsb_theta_g_o_tpm} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.25]{figure/plot_ycsb_theta_g_o_abort} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_terminal_g_o_tpm} \label{fig:new_order_add_terminal_gathered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_terminal_g_o_abort} \label{fig:new_order_add_terminal_gathered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.25] {figure/plot_tpcc_terminal_s_o_tpm} \label{fig:new_order_add_terminal_scattered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.25]{figure/plot_tpcc_terminal_s_o_abort} \label{fig:new_order_add_terminal_scattered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[TPCC interactive transactions TPM]
    { 
      \includegraphics[scale=0.245] {figure/plot_tpcc_hotitem_g_i_tpm} \label{fig:tpcc_add_terminal_interactive:tpm}
      \captionsetup[subfigure]{margin={0cm,0cm}}
    }
    \subfloat[TPCC interactive transactions abort rate]
    { 
      \includegraphics[scale=0.245]{figure/plot_tpcc_hotitem_g_i_abort} \label{fig:tpcc_add_terminal_interactive:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[\small no transactions access non-exist rows]
      { \includegraphics[scale=0.25] {figure/plot_cascade_0.pdf} \label{fig:evaluation_cascade_abort:without_nonexist_row}

      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
  \subfloat[\small 10\% transactions access  non-exist rows]
      { \includegraphics[scale=0.25]{figure/plot_cascade_10.pdf} \label{fig:evaluation_cascade_abort:nonexist_row}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[deadlock detection]
      { \includegraphics[scale=0.25] {figure/tpcc_neworder_add_Terminal_latency_Detection.pdf} \label{fig:evaluation_latency:deadlock_detection}
      }
  \subfloat[deadlock prevention ]
      { \includegraphics[scale=0.25]{figure/tpcc_neworder_add_Terminal_latency_WaitDie.pdf} \label{fig:evaluation_latency:deadlock_prevention}}
