...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.20] {figure/plot_ycsb_add_LogForceT_LogForceT_TPM_gather} \label{fig:new_order_add_log_cost:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.20]{figure/plot_ycsb_add_LogForceT_LogForceT_Abort_gather} \label{fig:new_order_add_log_cost:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.20] {figure/plot_tpcc_neworder_add_Warehouse_Warehouse_TPM_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.20]{figure/plot_tpcc_neworder_add_Warehouse_Warehouse_Abort_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.20] {figure/plot_tpcc_neworder_add_HotItem_HotItem_TPM_gather} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.20]{figure/plot_tpcc_neworder_add_HotItem_HotItem_Abort_gather} \label{fig:plot_tpcc_neworder_add_HotItem_HotItem_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.20] {figure/plot_ycsb_add_Theta_Theta_TPM_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.20]{figure/plot_ycsb_add_Theta_Theta_Abort_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.20] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_gather} \label{fig:new_order_add_terminal_gathered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.20]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_gather} \label{fig:new_order_add_terminal_gathered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder TPM]
      { \includegraphics[scale=0.20] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_scatter} \label{fig:new_order_add_terminal_scattered:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.20]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_scatter} \label{fig:new_order_add_terminal_scattered:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[\small no transactions access non-exist rows]
      { \includegraphics[scale=0.25] {figure/plot__tpcc_neworder_add_NonExist_0.pdf} \label{fig:evaluation_cascade_abort:without_nonexist_row}

      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
  \subfloat[\small 10\% transactions access non-exist rows]
      { \includegraphics[scale=0.25]{figure/plot__tpcc_neworder_add_NonExist_10.pdf} \label{fig:evaluation_cascade_abort:nonexist_row}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[Deadlock detection]
      { \includegraphics[scale=0.28] {figure/tpcc_neworder_add_Terminal_latency_Detection.pdf} \label{fig:evaluation_latency:deadlock_detection}
      }
  \subfloat[Deadlock prevention]
      { \includegraphics[scale=0.28]{figure/tpcc_neworder_add_Terminal_latency_WaitDie.pdf} \label{fig:evaluation_latency:deadlock_prevention}}
