...
\begin{figure}[htbp]
  ...
  \subfloat[NewOrder throughput]
      { \includegraphics[scale=0.40] {figure/plot_tpcc_neworder_add_LogForceT_LogForceT_TPM_gather} \label{fig:new_order_add_log_cost:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_LogForceT_LogForceT_Abort_gather} \label{fig:new_order_add_log_cost:abort}}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      \subfloat[throughput percentage increase against S2PL]
          { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_LogForceT_LogForceT_Ratio_gather} \label{fig:new_order_add_log_cost:ratio}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder throughput]
      { \includegraphics[scale=0.40] {figure/plot_tpcc_neworder_add_Warehouse_Warehouse_TPM_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:tpm}}

  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Warehouse_Warehouse_Abort_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:abort}}

    \subfloat[throughput percentage increase against S2PL]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Warehouse_Warehouse_Ratio_gather} \label{fig:plot_tpcc_neworder_add_Warehouse_Warehouse_gather:ratio}}
\caption{throughput and abort rate of
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder throughput]
      { \includegraphics[scale=0.40] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_gather} \label{fig:new_order_add_terminal_gathered:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_gather} \label{fig:new_order_add_terminal_gathered:abort}}

    \subfloat[throughput percentage increase against S2PL]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Ratio_gather} \label{fig:new_order_add_terminal_gathered:ratio}}
...
\begin{figure}[htbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder throughput]
      { \includegraphics[scale=0.40] {figure/plot_tpcc_neworder_add_Terminal_Terminal_TPM_scatter} \label{fig:new_order_add_terminal_scattered:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[NewOrder abort rate]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Abort_scatter} \label{fig:new_order_add_terminal_scattered:abort}}

      \subfloat[throughput percentage increase against S2PL]
      { \includegraphics[scale=0.40]{figure/plot_tpcc_neworder_add_Terminal_Terminal_Ratio_scatter} \label{fig:new_order_add_terminal_scattered:ratio}}
...
\begin{figure}[htbp]
  \centering
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB workload throughput]
      { \includegraphics[scale=0.40] {figure/plot_ycsb_add_Theta_Theta_TPM_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}}
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB workload abort rate]
      { \includegraphics[scale=0.40]{figure/plot_ycsb_add_Theta_Theta_Abort_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      \subfloat[throughput percentage increase against S2PL]
          { \includegraphics[scale=0.40]{figure/plot_ycsb_add_Theta_Theta_Ratio_gather} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:ratio}}
