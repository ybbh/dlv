...
However, this may require an additional message round trip, especially for a one-shot transaction.
...
We used the YCSB workload, in which we set the size of the data to 400,00 rows and the skewness (theta) to 0.2.
