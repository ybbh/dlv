...
\begin{figure}[tbp]
  ...
  \captionsetup[subfigure]{margin={0cm,0cm}}
  \subfloat[YCSB TPM]
      { \includegraphics[scale=0.32] {figure/plot_ycsb_theta_g_o_tpm} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:tpm}
      
      \captionsetup[subfigure]{margin={0cm,0cm}}
      
      }
      \subfloat[YCSB abort rate]
      { \includegraphics[scale=0.32]{figure/plot_ycsb_theta_g_o_abort} \label{fig:plot_ycsb_add_Theta_Theta_TPM_gather:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
...
\begin{figure}[tbp]
  ...
  \subfloat[TPCC interactive transactions TPM]
    { 
      \includegraphics[scale=0.32] {figure/plot_tpcc_hotitem_g_i_tpm} \label{fig:tpcc_add_terminal_interactive:tpm}
      \captionsetup[subfigure]{margin={0cm,0cm}}
    }
    \subfloat[TPCC interactive transactions abort rate]
    { 
      \includegraphics[scale=0.32]{figure/plot_tpcc_hotitem_g_i_abort} \label{fig:tpcc_add_terminal_interactive:abort}
      \captionsetup[subfigure]{margin={0cm,0cm}}
      }
